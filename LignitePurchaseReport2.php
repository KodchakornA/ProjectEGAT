...
<div>
    ...
    <table style="width: 700px" border="1">
        <thead>
            <tr>
                <th colspan="7"style="background-color: #f698a3; height: 40px">น้ำหนักถ่านเครื่องชั่ง Route Start (ปี <?php echo $_POST['Year']?>)</th>
            </tr>
            <tr>
...
<?php
    ...
    <table style="width: 1200px; font-size: 25px;" border="1">
        <thead>
            <tr>
                <th style="text-align: left; font-size: 25px; background-color: #ffe95e; height: 40px">ปรับราคาจากปริมาณ</th>
                <th colspan="2" style="text-align: right; background-color: #ffe95e; font-size: 24px">
                    10%
                </th>
            </tr>
        </thead>
        <tbody>
                <tr>
                    <th style="text-align: left; background-color: #FFFFE0; height: 40px">ปริมาณถ่านตามแผนรายปี</th>
                    <td style="text-align: right; background-color: #FFFFE0; width: 250px"><?php echo number_format(intval($_POST['volume']))?></td>
                    <td style="text-align: right; background-color: #FFFFE0; width: 90px">ตัน</td>
                </tr>
                    <th style="text-align: left; background-color: #FFFFE0; height: 40px">ปริมาณถ่านตามแผนรายปีที่ 90%</th>
                    <td style="text-align: right; background-color: #FFFFE0;"> <?php echo number_format(intval($_POST['volume'])*(1-(10/100)))?></td>
                    <td style="text-align: right; background-color: #FFFFE0;">ตัน</td>
                </tr>
                <tr>
                    <th style="text-align: left; background-color: #FFFFE0; height: 40px">ปริมาณถ่านจาก Coal Feeder <?php echo $_POST['month'] . " " .$_POST['Year']?></th>
                    <td style="text-align: right; background-color: #FFFFE0;"> <?php echo number_format($totalCoalFeederSum)?></td>
                    <td style="text-align: right; background-color: #FFFFE0;">ตัน</td>
                </tr> 
                <tr>
                    <th style="text-align: left; background-color: #FFFFE0; height: 40px">ปริมาณถ่านจาก Coal Feeder (สะสม) คิดเป็น</th>
                    <td colspan="2" style="text-align: right; background-color: #FFFFE0;">
                        <?php echo $year_plan; ?> ของปริมาณถ่านตามแผนรายปี
                    </td>
                </tr>
                <tr>
                    <th colspan = "3" style="text-align: left; background-color: #FFFFE0; height: 40px">สูตรปรับราคาจากการรับมอบปริมาณถ่านไม่ได้ตามแผน</th>
                </tr>
                <tr>
                    <th colspan = "3" style="text-align: right; background-color: #FFFFE0; height: 40px"> = คิดเป็นราคาถ่านต่อตัน x ปริมาณถ่านส่วนที่น้อยกว่า 10% ของปริมาณถ่านจากแผนงานรายปี </th>
                </tr>
                <tr>
                    <th style="text-align: left; background-color: #FFFFE0; height: 40px">ค่าปรับราคาจากปริมาณถ่าน = </th>
                    <td style="text-align: right; background-color: #FFFFE0;"><?php echo number_format($fine_volume,2)?></td>
                    <td style="text-align: right; background-color: #FFFFE0;">บาท/ตัน</td>
                </tr>
            </tbody>
    </table>
</div>
...
echo '<span style="font-size: 20px;">ใช้เวลาประมวลผลทั้งหมด: ' . number_format($duration, 6) . ' seconds</span>';
